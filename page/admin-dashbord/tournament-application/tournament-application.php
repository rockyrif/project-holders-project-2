        ...
        <div class="home">
            ...
            <div class="admin-dashbord container">
                                ...
                                <form action="tournament-application.php" method="GET">
                                    ...
                                    <div class="row container mb-3">
                                        ...
                                        <div class="form-check col-md-4">
                                            <input class="form-check-input" type="checkbox" value="m.`member_id`" name="column[]" id="flexCheckIndeterminate" <?= (isset($_GET['column']) && in_array('`member_id`', $_GET['column'])) ? 'checked' : ''; ?>>
                                    ...
                                    <div class="row container mb-3">
                                        <div class="form-check col-md-4">
                                            <input class="form-check-input" type="checkbox" value="ts.`tournament_id`" name="column[]" id="flexCheckIndeterminate" <?= (isset($_GET['column']) && in_array('ts.`id`', $_GET['column'])) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="flexCheckIndeterminate">
                                                Tournament ID
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check col-md-4">
                                            <input class="form-check-input" type="checkbox" value="`age_category[]`" name="column[]" id="flexCheckIndeterminate" <?= (isset($_GET['column']) && in_array('`age_category[]`', $_GET['column'])) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="flexCheckIndeterminate">
                                                Age Category
                                            </label>
                                        </div>
                                    ...
                                    <div class="row container mb-3">
                                        ...
                                        <div class="form-check col-md-4">
                                            <input class="form-check-input" type="checkbox" value="`application_id`" name="column[]" id="flexCheckIndeterminate" <?= (isset($_GET['column']) && in_array('ta.`tournament_id `', $_GET['column'])) ? 'checked' : ''; ?>>
                                            <label class="form-check-label" for="flexCheckIndeterminate">
                                                Application ID
                                            </label>
                                        </div>
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["fee_id"]) && isset($_POST["status"])) {
                    ...
                    $sql = "UPDATE `tournament-application` SET payment_status = '$status' WHERE application_id = '$feeId'";
                        ...
                        <table class="table table-hover text-center ">
                            ...
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <?php
                                    if (isset($_GET['column']) && in_array('`age_category[]`', $_GET['column'])) {
                                    ?>
                            ...
                            <tbody>
                                ...
                                if (!empty($_GET['month'])) {
                                    ...
                                    $conditions[] = "MONTH(ts.start_date) = '$month'";
                                }
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <?php
                                            if (isset($_GET['column']) && in_array('`date_of_birtd`', $_GET['column'])) {
                                            ?>
                                                <td>DOB</td>
                                            <?php
                                            }
