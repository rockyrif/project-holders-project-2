            ...
            <nav class="navbar">
                <div class="container">
                    ...
                    <a href="" class="navbar-brand fs-4">
                        <img src="Images/logo.png" alt="Tennis court logo" width="70">
                    ...
                    <div class="navbar-nav-outer ">
                        ...
                        <div class="nav-item-outer">
                            <a href="page/AboutUs-page/About-us.html" class="nav-link nav-link-about">ABOUT US</a>
                        </div>
                        <div class="nav-item-outer">
                        ...
                        <div class="offcanvas-body">
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="page/gallery-page/courts/courts.html">About
                                                courts we have</a></li>
                                        <li><a class="dropdown-item" href="page/gallery-page/courts/courts.html">Image
                                                Gallery</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item"
                                                href="page/Find-a-coach/Find-a-coach-page.html">Find a Coach</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
